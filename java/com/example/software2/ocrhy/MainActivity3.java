        ...
        textToSpeech = new TextToSpeech(getApplicationContext(), new TextToSpeech.OnInitListener() {
            ...
            public void onInit(int status) {
                if (status != TextToSpeech.ERROR) {
                    ...
                    textToSpeech.speak("Opening the calculator......  just tap on the screen and say what you want to calculate or say what you want And Press the volume up button to return the main menu", TextToSpeech.QUEUE_FLUSH, null);
        ...
        switch (requestCode) {
            case REQ_CODE_SPEECH_INPUT: {
                if (resultCode == RESULT_OK && null != data) {
                    ...
                    if (txtInput.getText().toString().equals("call")) {
                    ...
                    if (txtInput.getText().toString().equals("main menu")) {
