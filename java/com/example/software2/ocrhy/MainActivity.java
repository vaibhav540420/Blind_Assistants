...
import com.example.software2.ocrhy.MainActivity9;
        ...
        textToSpeech = new TextToSpeech(this, new TextToSpeech.OnInitListener() {
            ...
            public void onInit(int status) {
                if (status != TextToSpeech.ERROR) {
                    ...
                    if (firstTime == 0)
                        textToSpeech.speak("Welcome to Blind Assistance App. Swipe left to listen the features of the app and swipe right and say what you want", TextToSpeech.QUEUE_FLUSH, null);
                }
            }
        });
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQ_CODE_SPEECH_INPUT) {
            if (resultCode == RESULT_OK && null != data) {
                ...
                if (mVoiceInputTv.getText().toString().equals("call")) {
                ...
                if (mVoiceInputTv.getText().toString().equals("yes")) {
                    textToSpeech.speak("  Say call for call, Read for reading,  calculator for calculator,  time and date,  weather for weather,  battery for battery. Do you want to listen again", TextToSpeech.QUEUE_FLUSH, null);
                    mVoiceInputTv.setText(null);
