        ...
        textToSpeech = new TextToSpeech(this, new TextToSpeech.OnInitListener() {
            ...
            public void onInit(int status) {
                if (status != TextToSpeech.ERROR) {
                    ...
                    textToSpeech.speak("say call for call, read for read, Location for location,  Weather for weather, calculator for calculator, Time and date,  Battery. say exit to close the application.  Swipe right and say what you want", TextToSpeech.QUEUE_FLUSH, null);
                }
            }
        });
